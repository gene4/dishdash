...
export const Navbar = () => {
    ...
    return (
        <header className="flex sticky z-50 top-0 bg-background/95 backdrop-blur items-center justify-between px-3 md:px-6 h-14 border-b shadow-sm">
            <Link className="flex justify-start items-end gap-2" href="/">
                {logo}
